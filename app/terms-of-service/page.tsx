                    ...
                    <div className="p-6 md:p-10 lg:p-14 space-y-12">
                        ...
                        <section>
                            ...
                            <p className="text-base md:text-xl font-bold leading-relaxed border-l-4 border-indigo-500 pl-4 md:pl-6">
                                Dengan guna <strong>Kmlxly Apps</strong> (SplitIt, TripIt, Sub.Tracker), anda setuju dengan syarat ni. Apps ini hanyalah alat bantuan (utility).
                            </p>
                        </section>
                        ...
                        <section className="border-4 border-black border-dashed p-6 md:p-8 rounded-2xl bg-red-50 relative mt-10">
                            ...
                            <ul className="space-y-4 font-bold text-xs md:text-sm">
                                ...
                                <li className="flex items-start gap-3">
                                    <div className="w-1.5 h-1.5 bg-red-500 rounded-full mt-1.5 flex-shrink-0" />
                                    <span>Ramalan cuaca & info travel adalah anggaran sahaja. Kami tidak tanggung kerugian tiket/hotel.</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="w-1.5 h-1.5 bg-red-500 rounded-full mt-1.5 flex-shrink-0" />
                                    <span>Kami tidak menyimpan data kad kredit anda secara terus.</span>
                                </li>
                            </ul>
                        </section>
